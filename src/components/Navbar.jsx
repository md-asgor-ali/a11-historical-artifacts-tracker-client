  ...
  return (
    <div className="navbar bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 shadow-md sticky top-0 z-50">
      <div className="navbar-start">
        ...
        <Link
          to="/"
          className="btn btn-ghost text-xl font-extrabold text-purple-800 flex items-center gap-2"
        >
          <img src={logo} alt="Logo" className="w-10 h-10 rounded-full" />
          <span className="hidden sm:inline">Historical Artifacts Tracker</span>
        </Link>
      </div>
